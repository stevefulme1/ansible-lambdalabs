...
"""List or get details about Lambda Labs instance tags."""
...
DOCUMENTATION = r"""
---
module: instance_tag_info
short_description: List or get Lambda Labs instance tags
description:
  - Retrieve information about instance tags.
...
seealso:
  - module: stevefulme1.lambdalabs.instance_tag
"""

EXAMPLES = r"""
- name: List all instance tags
  stevefulme1.lambdalabs.instance_tag_info:
...
def main():
    ...
    try:
        ...
        if instance_id:
            ...
            items = result.get("data", [])
        module.exit_json(changed=False, instance_tags=items)
