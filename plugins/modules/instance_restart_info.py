...
"""List or get details about Lambda Labs restarted instances."""
...
DOCUMENTATION = r"""
---
module: instance_restart_info
short_description: List or get Lambda Labs restarted instances
description:
  - Retrieve information about restarted instances.
...
seealso:
  - module: stevefulme1.lambdalabs.instance_restart
"""

EXAMPLES = r"""
- name: List all restarted instances
...
RETURN = r"""
restarted_instances:
  description: List of restarted instances.
  type: list
  returned: always
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        if instance_id:
            result = client.get("instances/{0}".format(instance_id))
            items = [result.get("data", {})]
        else:
            result = client.get("instances")
            items = result.get("data", [])
        module.exit_json(changed=False, restarted_instances=items)
