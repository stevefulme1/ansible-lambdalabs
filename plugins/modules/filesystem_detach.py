...
"""Detach a filesystem from a Lambda Labs instance."""
...
DOCUMENTATION = r"""
---
module: filesystem_detach
short_description: Detach filesystem from instance
description:
  - Detach a persistent filesystem from a running instance.
version_added: "1.0.0"
extends_documentation_fragment:
  - stevefulme1.lambdalabs.lambdalabs
options:
  instance_id:
    description: Instance ID to detach from.
    type: str
    required: true
  filesystem_id:
    description: Filesystem ID to detach.
    type: str
    required: true
author:
  - Steve Fulmer
...
EXAMPLES = r"""
- name: Detach filesystem
  stevefulme1.lambdalabs.filesystem_detach:
...
RETURN = r"""
result:
  description: Detach operation result.
  type: dict
  returned: success
"""
...
def main():
    ...
    try:
        result = client.post(
            "file-systems/{0}/detach".format(module.params["filesystem_id"]),
