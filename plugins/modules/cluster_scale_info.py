...
"""List or get details about Lambda Labs cluster scaling configurations."""
...
DOCUMENTATION = r"""
---
module: cluster_scale_info
short_description: List or get Lambda Labs cluster scaling configurations
description:
  - Retrieve information about cluster scaling configurations.
...
seealso:
  - module: stevefulme1.lambdalabs.cluster_scale
"""

EXAMPLES = r"""
- name: List all cluster scaling configurations
  stevefulme1.lambdalabs.cluster_scale_info:
...
RETURN = r"""
scaling_configs:
  description: List of cluster scaling configurations.
  type: list
  returned: always
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        if cluster_id:
            ...
            items = result.get("data", [])
        module.exit_json(changed=False, scaling_configs=items)
