...
"""List or get details about Lambda Labs generated SSH keys."""
...
DOCUMENTATION = r"""
---
module: ssh_key_generate_info
short_description: List Lambda Labs generated SSH keys
description:
  - Retrieve information about generated SSH keys.
...
seealso:
  - module: stevefulme1.lambdalabs.ssh_key_generate
"""

EXAMPLES = r"""
- name: List all generated SSH keys
  stevefulme1.lambdalabs.ssh_key_generate_info:
...
RETURN = r"""
generated_keys:
  description: List of generated SSH keys.
  type: list
  returned: always
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        module.exit_json(changed=False, generated_keys=items)
