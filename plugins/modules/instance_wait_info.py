...
"""List or get details about Lambda Labs instance wait status."""
...
DOCUMENTATION = r"""
---
module: instance_wait_info
short_description: List or get Lambda Labs instance wait status
description:
  - Retrieve information about instance wait status.
...
seealso:
  - module: stevefulme1.lambdalabs.instance_wait
"""

EXAMPLES = r"""
- name: List all instance wait status
...
RETURN = r"""
wait_status:
  description: List of instance wait status.
  type: list
  returned: always
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        if instance_id:
            ...
            items = result.get("data", [])
        module.exit_json(changed=False, wait_status=items)
