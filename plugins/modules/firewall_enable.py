...
"""Enable firewall on a Lambda Labs instance."""
...
DOCUMENTATION = r"""
---
module: firewall_enable
short_description: Enable firewall on instance
description:
  - Enable the firewall on a Lambda Labs instance.
version_added: "1.0.0"
...
- name: Enable firewall
  stevefulme1.lambdalabs.firewall_enable:
...
def main():
    ...
    try:
        result = client.post("instances/{0}/firewall/enable".format(module.params["instance_id"]))
