...
"""List or get details about Lambda Labs filesystem attachments."""
...
DOCUMENTATION = r"""
---
module: filesystem_attach_info
short_description: List or get Lambda Labs filesystem attachments
description:
  - Retrieve information about filesystem attachments.
...
seealso:
  - module: stevefulme1.lambdalabs.filesystem_attach
"""

EXAMPLES = r"""
- name: List all filesystem attachments
  stevefulme1.lambdalabs.filesystem_attach_info:
...
filesystem_attachments:
  description: List of filesystem attachments.
  type: list
  returned: always
  elements: dict
  contains:
...
def main():
    ...
    try:
        ...
        if filesystem_id:
            ...
            items = result.get("data", [])
        module.exit_json(changed=False, filesystem_attachments=items)
