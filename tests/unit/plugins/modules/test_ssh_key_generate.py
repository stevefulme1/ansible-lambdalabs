...
def mock_api_client():
    ...
    client.create.return_value = {"id": "res-123", "name": "test-ssh_key_generate"}
    client.update.return_value = {"id": "res-123", "name": "test-ssh_key_generate-updated"}
...
class TestCreateSshKeyGenerate:
    ...
    def test_create_api_error(self):
        ...
        with pytest.raises(Exception, match="409 Conflict"):
            client.create("ssh_key_generate", {"name": "test"})
...
class TestDeleteSshKeyGenerate:
    ...
    def test_delete_nonexistent(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404"):
            mock_api_client.delete("ssh_key_generate", "missing")
