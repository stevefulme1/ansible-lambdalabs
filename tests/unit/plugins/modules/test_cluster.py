...
def mock_api_client():
    ...
    client.create.return_value = {"cluster_id": "res-123", "name": "test-cluster"}
    client.update.return_value = {"cluster_id": "res-123", "name": "test-cluster-updated"}
...
class TestCreateCluster:
    ...
    def test_create_returns_resource(self, mock_api_client):
        ...
        assert result["cluster_id"] == "res-123"
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        mock_api_client.create("cluster", params)
        mock_api_client.create.assert_called_once_with("cluster", params)
...
class TestUpdateCluster:
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("cluster", "res-123", {"name": "updated"})
        assert result["name"] == "test-cluster-updated"
...
class TestDeleteCluster:
    ...
    def test_delete_nonexistent_is_noop(self, mock_api_client):
        ...
        result = mock_api_client.get("cluster", "missing-id")
...
class TestGetCluster:
    ...
    def test_get_nonexistent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        result = mock_api_client.get("cluster", "nonexistent")
        assert result is None
...
class TestListCluster:
    ...
    def test_list_returns_all(self, mock_api_client):
        ...
        mock_api_client.list.return_value = [
            {"cluster_id": "1", "name": "first"},
            {"cluster_id": "2", "name": "second"},
        ]
        result = mock_api_client.list("cluster")
        assert len(result) == 2
...
class TestIdempotencyCluster:
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("cluster", "res-123")
