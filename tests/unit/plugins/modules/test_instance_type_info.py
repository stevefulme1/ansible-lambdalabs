...
class TestListInstanceTypeInfo:
    """Tests for listing via instance_type_info."""
    ...
    def test_list_with_pagination(self, mock_api_client):
        ...
        mock_api_client.list("instance_type_info", limit=10, offset=0)
        mock_api_client.list.assert_called_with("instance_type_info", limit=10, offset=0)
