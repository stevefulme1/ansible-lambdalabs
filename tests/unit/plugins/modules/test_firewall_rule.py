...
def mock_api_client():
    ...
    client.create.return_value = {"rule_id": "res-123", "description": "test-firewall_rule"}
    client.update.return_value = {"rule_id": "res-123", "description": "test-firewall_rule-updated"}
...
class TestCreateFirewallRule:
    ...
    def test_create_returns_resource(self, mock_api_client):
        ...
        result = mock_api_client.create("firewall_rule", {"description": "test-firewall_rule"})
        assert result["rule_id"] == "res-123"
        assert result["description"] == "test-firewall_rule"
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        mock_api_client.create("firewall_rule", params)
        mock_api_client.create.assert_called_once_with("firewall_rule", params)
...
class TestUpdateFirewallRule:
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("firewall_rule", "res-123", {"description": "updated"})
        assert result["description"] == "test-firewall_rule-updated"
    ...
    def test_update_idempotent_no_change(self, mock_api_client, existing_resource):
        ...
        desired = {"description": existing_resource["description"]}
        current = {"description": existing_resource["description"]}
...
class TestDeleteFirewallRule:
    ...
    def test_delete_existing(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        mock_api_client.delete("firewall_rule", "res-123")
        mock_api_client.delete.assert_called_once_with("firewall_rule", "res-123")

    def test_delete_nonexistent_is_noop(self, mock_api_client):
        """Verify deleting absent resource reports no change."""
        mock_api_client.get.return_value = None
        result = mock_api_client.get("firewall_rule", "missing-id")
...
class TestGetFirewallRule:
    ...
    def test_get_existing(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        result = mock_api_client.get("firewall_rule", "res-123")
        assert result["rule_id"] == "res-123"

    def test_get_nonexistent(self, mock_api_client):
        """Verify get returns None for missing resource."""
        mock_api_client.get.return_value = None
        result = mock_api_client.get("firewall_rule", "nonexistent")
        assert result is None
...
class TestListFirewallRule:
    ...
    def test_list_returns_all(self, mock_api_client):
        ...
        mock_api_client.list.return_value = [
            {"rule_id": "1", "description": "first"},
            {"rule_id": "2", "description": "second"},
        ]
        result = mock_api_client.list("firewall_rule")
        assert len(result) == 2
...
class TestIdempotencyFirewallRule:
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("firewall_rule", "res-123")
        desired_params = {"description": current["description"]}
        # If resource exists and matches desired state, no change
        changed = desired_params["description"] != current["description"]
        assert changed is False
