"""Unit tests for stevefulme1.lambdalabs.ssh_key module."""

from unittest.mock import MagicMock

import pytest
MODULE_PATH = "ansible_collections.stevefulme1.lambdalabs.plugins.modules.ssh_key"
...
def mock_api_client():
    ...
    client.create.return_value = {"key_id": "res-123", "name": "test-ssh_key"}
    client.update.return_value = {"key_id": "res-123", "name": "test-ssh_key-updated"}
...
class TestCreateSshKey:
    ...
    def test_create_with_all_params(self, mock_api_client):
        ...
        mock_api_client.create("ssh_key", params)
        mock_api_client.create.assert_called_once_with("ssh_key", params)
...
class TestUpdateSshKey:
    ...
    def test_update_existing_resource(self, mock_api_client, existing_resource):
        ...
        result = mock_api_client.update("ssh_key", "res-123", {"name": "updated"})
        assert result["name"] == "test-ssh_key-updated"
    ...
    def test_update_nonexistent_raises(self, mock_api_client):
        ...
        with pytest.raises(Exception, match="404 Not Found"):
            mock_api_client.update("ssh_key", "bad-id", {})
class TestDeleteSshKey:
    ...
    def test_delete_nonexistent_is_noop(self, mock_api_client):
        ...
        result = mock_api_client.get("ssh_key", "missing-id")
    ...
    def test_delete_api_error(self):
        ...
        with pytest.raises(Exception, match="403 Forbidden"):
            client.delete("ssh_key", "res-123")
class TestGetSshKey:
    """Tests for getting a ssh_key."""
    ...
    def test_get_nonexistent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        result = mock_api_client.get("ssh_key", "nonexistent")
        assert result is None
    ...
    def test_get_api_timeout(self):
        ...
        with pytest.raises(TimeoutError):
            client.get("ssh_key", "res-123")
class TestListSshKey:
    """Tests for listing ssh_key resources."""
    ...
    def test_list_returns_all(self, mock_api_client):
        ...
        result = mock_api_client.list("ssh_key")
        assert len(result) == 2
    ...
    def test_list_with_filter(self, mock_api_client):
        ...
        result = mock_api_client.list("ssh_key", filters={"name": "match"})
        assert len(result) == 1
class TestIdempotencySshKey:
    """Tests for idempotent behavior of ssh_key."""
    ...
    def test_create_existing_is_idempotent(self, mock_api_client, existing_resource):
        ...
        mock_api_client.get.return_value = existing_resource
        current = mock_api_client.get("ssh_key", "res-123")
    ...
    def test_delete_absent_is_idempotent(self, mock_api_client):
        ...
        mock_api_client.get.return_value = None
        exists = mock_api_client.get("ssh_key", "missing") is not None
        assert exists is False
class TestErrorHandlingSshKey:
    """Tests for error handling in ssh_key."""
